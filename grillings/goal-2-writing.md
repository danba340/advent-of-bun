...
Section drafts and Lisa's approvals. Portfolio text lives in `portfolio/text.md`.

## Q13 — Start Goal 2 with the Opening?

Asked: start Goal 2 with the Opening? Recommended: yes. Write Opening first, then Coordinator desktop, Porter mobile, SASICU, Close.
